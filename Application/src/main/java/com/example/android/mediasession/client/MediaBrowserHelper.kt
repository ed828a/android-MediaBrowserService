...
open class MediaBrowserHelper(private val mContext: Context,
    ...
    private val mMediaBrowserConnectionCallback: MediaBrowserConnectionCallback = MediaBrowserConnectionCallback()
    private val mMediaControllerCallback: MediaControllerCallback  = MediaControllerCallback()
    private val mMediaBrowserSubscriptionCallback: MediaBrowserSubscriptionCallback  = MediaBrowserSubscriptionCallback()
